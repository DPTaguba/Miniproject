<?php
$name = "Dave Paolo R. Taguba";
$course = "Bachelor of Science in Information Technology";
$school = "University of Mindanao";
$address = " I lived in Purok Dacudao Brngy Lizada Toril Davao City";
$age = "I am 20 years old. I am the one and only son.";
?>
...
<section class="about-container">
    ...
    <div class="about-text">
        <?php
            ...
            echo "<h2>$course</h2>";
            echo "<h2>$school</h2>";
            echo "<p>Welcome to my portfolio website! Here you can find information about me and how to contact me.</p>";
